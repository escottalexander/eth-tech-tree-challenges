...
```bash
    npx create-eth@1.0.2 -e BuidlGuidl/eth-tech-tree-challenges:token-wrapper-weth-extension token-wrapper-weth
```
...
```
Now you need to verify it on Sepolia Etherscan (or the explorer for your chosen network).
```bash
  yarn verify --network sepolia
```
Copy your deployed contract address from your console and paste it in at [sepolia.etherscan.io](https://sepolia.etherscan.io) (or the explorer for your chosen network). You should see a green checkmark on the "Contract" tab showing that the source code has been verified.
